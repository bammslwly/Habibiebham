...
tampilkan_menu_utama() {
    ...
    echo "┌───────────────────────────────────────────────┐"
    echo "│ ${PUTIH}1. Cek Waktu & Tanggal Sistem${NC}                 │"
    echo "│ ${PUTIH}2. Lihat Isi Direktori Saat Ini${NC}              │"
    echo "│ ${PUTIH}3. Analisa Jaringan & Koneksi${NC}                │"
    echo "│ ${PUTIH}4. Spesifikasi Sistem & Perangkat${NC}            │"
    echo "│ ${PUTIH}5. Estimasi Tanggal Instalasi OS${NC}             │"
    echo "│ ${PUTIH}6. Detail Akun Pengguna${NC}                      │"
    echo "├───────────────────────────────────────────────┤"
    echo "│ ${MERAH}0. Keluar dari Aplikasi${NC}                      │"
    echo "└───────────────────────────────────────────────┘"
    echo ""
}
